...
アプリの画面構成は、左側に支出を入力するフォーム、右側に支出の一覧や分析結果を表示するダッシュボードという構成を採用しました。これにより、操作性と視認性の両立を意識しています。また、支出データは Pandas を用いて集計処理を行い、カテゴリ別の合計金額を棒グラフとして表示することで、どの分野にどれだけお金を使っているかを直感的に把握できるようにしました。
